---
title: MASCOT
summary: Multi-agent socio-collaborative companion systems that stay in character and contribute meaningfully.
tags:
  - Multi-Agent Systems
  - LLM Agents
...
image:
  caption: 'MASCOT framework overview (adapted from the paper).'
  focal_point: Smart
  preview_only: false
  alt_text: 'Two-phase MASCOT framework diagram.'
