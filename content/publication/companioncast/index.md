...
url_pdf: 'https://arxiv.org/abs/2512.10918'

image:
  caption: 'CompanionCast system workflow (adapted from Figure 1 of the paper).'
  focal_point: 'Smart'
  preview_only: false
  alt_text: 'Diagram of the CompanionCast pipeline from media source through replay-moment detection, multi-agent fan dialogue, an LLM judge, and spatial text-to-speech.'
